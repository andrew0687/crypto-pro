...
export var isValidEDSSettings = function () { return __awaiter(void 0, void 0, void 0, function () {
    var error_1;
...
var getCadesCert = function (hash) { return __awaiter(void 0, void 0, void 0, function () {
    var oStore, certs, certCnt, cert, err_1, err_2, count, err_3;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                if (!('CreateObjectAsync' in cadesPlugin)) return [3 /*break*/, 2];
            ...
            case 5:
                err_1 = _a.sent();
                throw new Error(getErrors('Ошибка при открытии хранилища: ', err_1));
            case 6:
                _a.trys.push([6, 9, , 10]);
            ...
            case 9:
                err_2 = _a.sent();
                throw new Error(getErrors('Ошибка получения списка сертификатов: ', err_2));
            case 10:
                if (!certCnt) {
            ...
            case 17:
                err_3 = _a.sent();
                throw new Error('Не удалось получить сертификат по хэшу: ' + err_3.message);
 ...
 * */
export var getCertsList = function (resetCache) {
    if (resetCache === void 0) { resetCache = false; }
    return __awaiter(void 0, void 0, void 0, function () {
        var oStore, result, certs, count, item, err_4, err_5, _a, _b, _c, err_6;
        var _d;
        return __generator(this, function (_e) {
            switch (_e.label) {
                ...
                case 5:
                    err_4 = _e.sent();
                    return [2 /*return*/, Promise.reject(getErrors('Ошибка при открытии хранилища: ', err_4))];
                case 6:
                ...
                case 12:
                    err_5 = _e.sent();
                    return [2 /*return*/, Promise.reject(getErrors('Ошибка получения списка сертификатов: ', err_5))];
                case 13:
                    if (!count) {
                ...
                case 23:
                    err_6 = _e.sent();
                    return [2 /*return*/, Promise.reject(getErrors('Ошибка обработки сертификатов: ', err_6))];
...
export var getCert = function (hash) { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        if (!hash) {
            throw new Error('Хэш не указан');
        }
        return [2 /*return*/, getCertsList().then(function (list) {
                var foundCert;
 ...
 * */
export var xmlSignCreate = function (hash, dataBase64) { return __awaiter(void 0, void 0, void 0, function () {
    var cert, oSignedData, oHashedData, oSigner, signature, sHashValue, err_7, err_8, err_9;
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 13:
                err_7 = _a.sent();
                return [2 /*return*/, Promise.reject(getErrors('Не удалось установить настройки для подписи: ', err_7))];
            case 14:
            ...
            case 16:
                err_8 = _a.sent();
                return [2 /*return*/, Promise.reject(getErrors('Не удалось создать подпись: ', err_8))];
            case 17:
            ...
            case 19:
                err_9 = _a.sent();
                return [2 /*return*/, Promise.reject(getErrors('Не удалось проверить подпись: ', err_9))];
 ...
 * @return {Promise} -- обещание, которое зарезолвится с данными о подписи {String}
 * */
export var signData = function (hash, dataBase64, signType) {
    if (signType === void 0) { signType = true; }
    return __awaiter(void 0, void 0, void 0, function () {
        var cert, clientTime, oAttrs, oSignedData, oSigner, attrs, signature, err_10, err_11, err_12;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, getCadesCert(hash)];
                case 1:
                ...
                case 8:
                    err_10 = _a.sent();
                    return [2 /*return*/, Promise.reject(getErrors('Ошибка при установке данных подписи: ', err_10))];
                case 9:
                ...
                case 16:
                    err_11 = _a.sent();
                    return [2 /*return*/, Promise.reject(getErrors('Не удалось установить настройки для подписи: ', err_11))];
                case 17:
                    _a.trys.push([17, 19, , 20]);
                ...
                case 19:
                    err_12 = _a.sent();
                    return [2 /*return*/, Promise.reject(getErrors('Не удалось создать подпись: ', err_12))];
                case 20: return [2 /*return*/, Promise.resolve(signature)];
                case 21: return [2 /*return*/, Promise.reject(new Error('Что-то пошло не так'))];
            }
        });
 ...
 * @return {Promise} -- обещание, которое зарезолвится с данными о подписи {String}
 * */
export var signBase64 = function (hash, dataBase64) { return __awaiter(void 0, void 0, void 0, function () {
    var cert, oSignedData, oSigner, signature, err_13, err_14;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, getCadesCert(hash)];
            case 1:
            ...
            case 9:
                err_13 = _a.sent();
                return [2 /*return*/, Promise.reject(getErrors('Не удалось установить настройки для подписи: ', err_13))];
            case 10:
            ...
            case 12:
                err_14 = _a.sent();
                return [2 /*return*/, Promise.reject(getErrors('Не удалось создать подпись: ', err_14))];
 ...
 * @return {Promise} -- обещание, которое зарезолвится с данными о подписи {String}
 * */
export var signDataXML = function (hash, dataXML) { return __awaiter(void 0, void 0, void 0, function () {
    var cert, oSigner, signerXML, signature, err_15, err_16, oSignedXML2, err_17;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, getCadesCert(hash)];
            case 1:
            ...
            case 11:
                err_15 = _a.sent();
                return [2 /*return*/, Promise.reject(getErrors('Не удалось установить настройки для подписи: ', err_15))];
            case 12:
            ...
            case 14:
                err_16 = _a.sent();
                return [2 /*return*/, Promise.reject(getErrors('Не удалось создать подпись: ', err_16))];
            ...
            case 19:
                err_17 = _a.sent();
                return [2 /*return*/, Promise.reject(getErrors('Failed to verify signature. Error: ', err_17))];
            case 20: return [2 /*return*/, Promise.resolve(signature)];
            case 21: return [2 /*return*/, Promise.reject(new Error('Что-то пошло не так'))];
        }
    });
...
export var getSystemInfo = function () { return __awaiter(void 0, void 0, void 0, function () {
    var sysInfo, e, cadesVersion, cspVersion, _a, _b, _c, err_18;
    return __generator(this, function (_d) {
        switch (_d.label) {
            ...
            case 11:
                err_18 = _d.sent();
                return [2 /*return*/, Promise.reject(getErrors('Ошибка при получении информации о системе: ', err_18))];
            case 12: return [2 /*return*/];
        }
    });
}); };
// Promise обертка для синхронного вызова проверки версии CSP
export var isValidCSPVersion = function (version) { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
...
export var isValidCadesVersion = function (version) { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
