...
var getCadesCert = function (hash) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 5:
                err_1 = _a.sent();
                throw new Error((0, common_1.getErrors)('Ошибка при открытии хранилища: ', err_1));
            case 6:
                _a.trys.push([6, 9, , 10]);
            ...
            case 9:
                err_2 = _a.sent();
                throw new Error((0, common_1.getErrors)('Ошибка получения списка сертификатов: ', err_2));
            case 10:
                if (!certCnt) {
    ...
    return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_e) {
            switch (_e.label) {
                ...
                case 5:
                    err_4 = _e.sent();
                    return [2 /*return*/, Promise.reject((0, common_1.getErrors)('Ошибка при открытии хранилища: ', err_4))];
                case 6:
                ...
                case 12:
                    err_5 = _e.sent();
                    return [2 /*return*/, Promise.reject((0, common_1.getErrors)('Ошибка получения списка сертификатов: ', err_5))];
                case 13:
                    if (!count) {
                ...
                case 22:
                    _b.apply(_a, [new (_c.apply(certificate_1.default, [void 0, (_d.validTo = _e.sent(),
                                _d)]))()]);
                    count--;
                    return [3 /*break*/, 24];
                case 23:
                    err_6 = _e.sent();
                    return [2 /*return*/, Promise.reject((0, common_1.getErrors)('Ошибка обработки сертификатов: ', err_6))];
...
var xmlSignCreate = function (hash, dataBase64) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 13:
                err_7 = _a.sent();
                return [2 /*return*/, Promise.reject((0, common_1.getErrors)('Не удалось установить настройки для подписи: ', err_7))];
            case 14:
            ...
            case 16:
                err_8 = _a.sent();
                return [2 /*return*/, Promise.reject((0, common_1.getErrors)('Не удалось создать подпись: ', err_8))];
            case 17:
            ...
            case 19:
                err_9 = _a.sent();
                return [2 /*return*/, Promise.reject((0, common_1.getErrors)('Не удалось проверить подпись: ', err_9))];
    ...
    return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 8:
                    err_10 = _a.sent();
                    return [2 /*return*/, Promise.reject((0, common_1.getErrors)('Ошибка при установке данных подписи: ', err_10))];
                case 9:
                ...
                case 16:
                    err_11 = _a.sent();
                    return [2 /*return*/, Promise.reject((0, common_1.getErrors)('Не удалось установить настройки для подписи: ', err_11))];
                case 17:
                    _a.trys.push([17, 19, , 20]);
                ...
                case 19:
                    err_12 = _a.sent();
                    return [2 /*return*/, Promise.reject((0, common_1.getErrors)('Не удалось создать подпись: ', err_12))];
                case 20: return [2 /*return*/, Promise.resolve(signature)];
                case 21: return [2 /*return*/, Promise.reject(new Error('Что-то пошло не так'))];
            }
        });
...
var signBase64 = function (hash, dataBase64) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 9:
                err_13 = _a.sent();
                return [2 /*return*/, Promise.reject((0, common_1.getErrors)('Не удалось установить настройки для подписи: ', err_13))];
            case 10:
            ...
            case 12:
                err_14 = _a.sent();
                return [2 /*return*/, Promise.reject((0, common_1.getErrors)('Не удалось создать подпись: ', err_14))];
...
var signDataXML = function (hash, dataXML) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 11:
                err_15 = _a.sent();
                return [2 /*return*/, Promise.reject((0, common_1.getErrors)('Не удалось установить настройки для подписи: ', err_15))];
            case 12:
            ...
            case 14:
                err_16 = _a.sent();
                return [2 /*return*/, Promise.reject((0, common_1.getErrors)('Не удалось создать подпись: ', err_16))];
            ...
            case 19:
                err_17 = _a.sent();
                return [2 /*return*/, Promise.reject((0, common_1.getErrors)('Failed to verify signature. Error: ', err_17))];
            case 20: return [2 /*return*/, Promise.resolve(signature)];
            case 21: return [2 /*return*/, Promise.reject(new Error('Что-то пошло не так'))];
        }
    });
...
var getSystemInfo = function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_d) {
        switch (_d.label) {
            ...
            case 11:
                err_18 = _d.sent();
                return [2 /*return*/, Promise.reject((0, common_1.getErrors)('Ошибка при получении информации о системе: ', err_18))];
